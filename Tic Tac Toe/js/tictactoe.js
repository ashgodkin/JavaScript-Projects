...
function placeXOrO(squareNumber) {
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        Audio('/Tic Tac Toe/media/place.mp3');
        if (activePlayer === 'O') {
            disableClick();
...
//for win conditions. drawLine() function is called to draw
//a line on the screen if conditions are met.
function checkWinConditions() {
    if (arrayIncludes('0X', '1X', '2X')) { drawWinLine(50, 100, 558, 100) }
        ...
        Audio('/Tic Tac Toe/media/tie.mp3');
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    disableClick();
    audio('/Tic Tac Toe/media/winGame.mp3');
    animateLineDrawing();
